...
const serverMessageTranslations: Record<string, string> = {
  ...
  'Approved materials cannot be edited.': 'לא ניתן לערוך חומר מאושר.',
  'Approved materials can only be archived by an admin.': 'חומר מאושר ניתן לארכב רק על ידי מנהל.',
  'Instrument is not available.': 'הכלי שנבחר אינו זמין.',
  ...
  'Cannot deactivate your own account.': 'לא ניתן להשבית את החשבון שלך.',
  'Cannot change your own admin role.': 'לא ניתן לשנות את תפקיד המנהל של החשבון שלך.',
  'At least one active admin is required.': 'חייב להישאר לפחות מנהל פעיל אחד.',
  'Cannot like your own material.': 'לא ניתן לסמן לייק לחומר שהעלית בעצמך.',
  'Material title is required.': 'יש להזין כותרת לחומר.',
  'Instrument name is required.': 'יש להזין שם כלי.',
  'User full name is required.': 'יש להזין שם מלא.',
  'User email is required.': 'יש להזין כתובת מייל.',
  'Current password is incorrect.': 'הסיסמה הנוכחית אינה נכונה.',
  'File is required.': 'יש לבחור קובץ.',
  'File name is required.': 'שם הקובץ חסר.',
  ...
  'File signature does not match file type.': 'תוכן הקובץ אינו תואם לסוג הקובץ.',
